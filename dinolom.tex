...
\begin{teo}[Controesempi di Cremer] Esiste un $G_\delta$ denso di valori di $\lambda\in\T^1$ tali che esiste $f\in G_\lambda$ non linearizzabile. Per Baire tale $G_\delta$ non contiene solo radici dell'unità.\end{teo}
...
\begin{teo}[Riemann]Ogni aperto $W\subsetneq\C$ semplicemente connesso è biolomorfo al disco.
