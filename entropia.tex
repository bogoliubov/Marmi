...
\begin{esempio}Consideriamo l'insieme delle successioni biinfinite su un alfabeto di $N$ simboli: poniamo $X:=\set{1,\dots,N}^{\Z}$.
...
Torniamo agli schemi di Bernoulli.
