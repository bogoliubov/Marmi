...
cioè tale che $f^{-1}\A\subseteq \A$ (ossia $f$ misurabile) e per ogni $A\in\A$ valga $\mu(f^{-1}A)=\mu(A)$. (Scegliamo questa definizione con $f^{-1}$ coerentemente con la nozione di misura immagine.)
