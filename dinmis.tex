...
\begin{teo}[Krylov-Bogoliubov] Dati $X$ spazio metrico compatto e $f:X\to X$ continua, esiste sempre una misura $f$-invariante.
\end{teo}
...
Lavoriamo d'ora in poi con un \emph{sistema dinamico misurabile} $(X,\mathcal{A},\mu,f)$,
