...
come pure $T'$).
Un integrale primo $F:X\to \R$ però è costante: si può verificare infatti che $\restr{f}{T}:T\to T$ è topologicamente transitivo 
(dimostrazione analoga a quella per i Flussi sul toro, nel relativo capitolo),
